...
function wonka_add_continue_shopping_notice_to_cart() {
	$shopping = printf( '<div class="return-shopping-wrap"><i class="fas fa-arrow-left"></i> <a href="%s" class="continue-shopping">%s</a></div>', esc_url( '/shop' ), esc_html__( 'Continue shopping', 'woocommerce' ) );
