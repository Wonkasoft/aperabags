...
function wonka_woocommerce_update_order_review_fragments( $fragments ) {
	ob_start();
	echo $fragments['tr.order-total'] = '<th>Total</th><td colspan="2"><strong><span class="woocommerce-Price-amount amount">' . wp_kses_data( WC()->cart->get_cart_total() ) . '</span></strong> </td>';
