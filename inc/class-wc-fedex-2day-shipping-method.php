<?php
/**
 * Class WC_FedEx_2day_Shipping_Method
 *
...
if ( ! class_exists( 'WC_FedEx_2day_Shipping_Method' ) ) {
	/**
	 * Begin class.
	 */
	class WC_FedEx_2day_Shipping_Method extends WC_Shipping_Method {
		...
		public function __construct() {
			$this->id                 = 'FedEx_2day'; // Id for your shipping method. Should be uunique.
