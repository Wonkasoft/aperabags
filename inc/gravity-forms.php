 ...
 * @return void
 */
function wonkasoft_gform_field_groups_form_editor( $field_groups ) {
    ...
    <script type='text/javascript'>
        ...
        jQuery(document).on("gform_load_field_settings", function(event, field, form){
			if ( 'Order Select' === field.type ) {
				...
				jQuery( '.label_setting' ).css( { 'display': 'list-item' } );
				jQuery( '.order_select' ).css( { 'display': 'list-item' } );
				if ( 'undefined' !== jQuery( '.order_select' ).attr("value", field.order_select ) ) {
