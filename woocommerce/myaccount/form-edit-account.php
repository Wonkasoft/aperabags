...
<section class="apera-programs-section">
	...
	<?php
		...
		<div class="program-wrapper">
			<div class="apera-programs-left-side">
				<?php
				...
				?>
				<a class="btn wonka-btn" href="<?php echo $zip_link; ?>"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="17px" height="17px" viewBox="0 0 750 750" enable-background="new 0 0 750 750" xml:space="preserve">
											<g id="Zip_Program">
												<g>
			...
			<div class="apera-programs-right-side">
				<?php
				...
				?>
				<a class="btn wonka-btn" href="<?php echo $ambassador_link; ?>"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="17px" height="17px" viewBox="0 0 750 750" enable-background="new 0 0 750 750" xml:space="preserve">
											<g id="Ambassadors">
												<g>
...
<section class="myaccount-section-divider">
	<div class="myaccount-divider">
		...
		<button class="btn wonka-btn"><i class="fa fa-check-o"></i> Save & Update</button>
	</div>
</section>
...
<form class="woocommerce-EditAccountForm edit-account strength-checker" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<p>
		...
		<button type="submit" class="woocommerce-Button button wonka-btn" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>"><?php esc_html_e( 'Save changes', 'woocommerce' ); ?></button>
