...
<?php if ( $has_methods ) : ?>
	...
	<table class="woocommerce-MyAccount-paymentMethods shop_table table table-hover account-payment-methods-table">
		<thead>
			<tr>
...
<?php if ( WC()->payment_gateways->get_available_payment_gateways() && is_checkout() ) : ?>
