...
<form method="post" class="wc-auth-login">
	...
	<p class="wc-auth-actions">
		...
		<button type="submit" class="button button-large button-primary wc-auth-login-button wonka-btn" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>"><?php esc_html_e( 'Login', 'woocommerce' ); ?></button>
